...
import { Link, connect, Dispatch, FormattedMessage, formatMessage } from 'umi';
import { StateType, LoginPayloadsType } from '@/models/login';
...
const Login: React.FC<LoginProps> = (props) => {
  ...
  const handleSubmit = (values: LoginPayloadsType) => {
